...
require (
	...
	github.com/docker/docker v1.0.0 // indirect
...
replace github.com/docker/docker => github.com/moby/moby v17.12.0-ce-rc1.0.20210128214336-420b1d36250f+incompatible
