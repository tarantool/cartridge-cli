 ...
 *    `0000003f000000070000001400000010000003e80000000600000000000000010000045c000000040000000800000003`
 *
...
func packTagSet(tagSet rpmTagSetType, regionTagID int) (*bytes.Buffer, error) {
	...
	for _, tag := range tagSet {
		...
		if err := common.ConcatBuffers(tagsData, packed.Data); err != nil {
			return nil, err
		}
	...
	if err := common.ConcatBuffers(resData, tagsData, regionTagData); err != nil {
		return nil, err
	}
