...
func getAvaliableConn(ctx *context.Ctx) (net.Conn, error) {
	...
	return nil, fmt.Errorf("No avaliable sockets found in: %s", ctx.Running.RunDir)
}
...
func getCliExtError(format string, a ...interface{}) error {
	const cliExtErrFmt = "%s. " +
		"Please update cartridge-cli-extentions module or " +
		"file an issue https://github.com/tarantool/cartridge-cli-extentions/issues/new"
